  ...
  public void generate() {
    ...
    case 1:
      int[][] array1 = { { 4, 7, 1, 3, 2, 8, 5, 9, 6 },
          { 6, 3, 9, 5, 1, 4, 7, 8, 2 }, { 5, 2, 8, 6, 7, 9, 1, 3, 4 },
          { 1, 4, 2, 9, 6, 7, 3, 5, 8 }, { 8, 9, 7, 2, 5, 3, 4, 6, 1 },
          { 3, 6, 5, 4, 8, 1, 2, 7, 9 }, { 9, 5, 6, 1, 3, 2, 8, 4, 7 },
          { 2, 8, 4, 7, 9, 5, 6, 1, 3 }, { 7, 1, 3, 8, 4, 6, 9, 2, 5 } };
